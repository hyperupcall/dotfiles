...
main() {
	...
	util.run "$dotfox" --config-dir="$HOME/.dotfiles/user/.config/dotfox" --deployment=all.sh deploy
	util.run "$dotfox" --config-dir="$HOME/.dotfiles/user/.config/dotfox" --deployment=all.sh status
}
