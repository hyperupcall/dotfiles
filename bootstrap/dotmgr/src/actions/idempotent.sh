...
action() {
	...
	# must_link "$XDG_CONFIG_HOME/Code/User/settings.json" "$XDG_CONFIG_HOME/Code - OSS/User/settings.json" # TODO
	...
	if [ -d "$storage" ]; then
		...
		must_rmdir "$HOME/Templates"
		must_rmdir "$HOME/Public"
		# must_rmdir "$HOME/Music"
		must_rmdir "$HOME/Pictures"
